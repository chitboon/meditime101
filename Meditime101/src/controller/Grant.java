        ...
        if (request.getParameter("completeAuthorization") != null) {
            ...
            if (!resourceCredentials.isAuthorized()) {
                ...
                try {
                    ...
                    ResourceCredentials rc = new ResourceCredentials();
                    rc.copy(resourceCredentials);
            ...
            try {
                response.sendRedirect(apiClientService.getResourceOwnerAuthorizationURL(new LocalUserDetail("-"), exampleBaseUrl + "/grant?completeAuthorization="));
            } catch (FitbitAPIException e) {
