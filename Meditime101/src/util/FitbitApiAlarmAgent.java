...
//public Alarm addAlarms(LocalUserDetail localUser ,String deviceId, String time, boolean enabled, String recurring, String[] weekDays) throws FitbitAPIException{
//        setAccessToken(localUser);
...
//}
   ...
   // public Alarm logAlarm(LocalUserDetail localUser, String alarmId, boolean deleted,boolean enabled, String label, boolean recurring, String snoozeCount,String snoozeLength, boolean syncedToDevice,String time, String vibe, String [] weekDays) throws FitbitAPIException {
//    public Alarm logAlarm(LocalUserDetail localUser, String time, boolean enabled, boolean recurring) throws FitbitAPIException {
...
//    
//    
//private Alarm logAlarm(LocalUserDetail localUser, List<PostParameter> params) throws FitbitAPIException {
//	 setAccessToken(localUser);
...
public void addAlarms(LocalUserDetail localUser ,String deviceId, String time, boolean enabled, boolean recurring, String[] weekDays) throws FitbitAPIException {
    setAccessToken(localUser);
...
//public Alarm addAlarms(LocalUserDetail localUser ,String deviceId, String time, boolean enabled, boolean recurring, String[] weekDays) throws FitbitAPIException {
//setAccessToken(localUser);
...
//} catch (JSONException e) {
//throw new FitbitAPIException("Error parsing json response to alarm : ", e);
//}
//}
