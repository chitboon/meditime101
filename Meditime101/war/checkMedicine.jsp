...
<%-- 
<% MedicineDataAO a = new MedicineDataAO(); %> --%>
...
<div class="container">
      ...
      <!-- Jumbotron -->
      <div class="jumbotron">
        <h1>Keep Track of Medicine</h1>
        <p class="lead">By keep tracking of the leftover medicine for the elderly. It would allows the caregiver to take note when will the medicine be finish and when to replenish it!</p>
